...
You may pick whichever license you prefer. This follows in the footsteps of the Rust ecosystem, but mostly Bevy's reasoning to switch to a dual-license model. ([see cart's issue on adding the Apache-2.0 License to the Bevy Engine](https://github.com/bevyengine/bevy/issues/2373)).
